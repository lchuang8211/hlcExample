package hlc.preset.example.data.local

import androidx.room.Database
import androidx.room.RoomDatabase
import hlc.preset.example.data.local.defaultTabble.RoomTableDemo
import hlc.preset.example.data.local.defaultTabble.DefaultTableDao
